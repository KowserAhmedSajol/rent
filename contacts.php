        ...
        <div class="container py-5">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div>
                        <form class="p-3 p-xl-4" id="contact-form" method="post" role="form" onsubmit="sendEmail(); reset(); return false;"  >
                            ...
                            <div><button class="btn btn-primary shadow d-block w-100" type="submit" name="create" value="Send">Send</button></div>
                        </form>
                    </div>
                </div>
