...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO property_list (user_id, status, property_name, rent_rate, property_type, gender, proximity, university_name, uni_location, full_address, description, water, electricity, maintenance, security_service, wifi, furniture, ac, meal_system, garbage, rules, phoneNumber, paymentMethod, transactionId, time) VALUES ('$id','$status','$property_Name','$property_rent', '$propertyType','$gender','$proximity','$uniName','$uniLocation','$address','$description','$waterFacility','$electricityFacility','$maintenaceFacility','$securityFacility','$wifiFacility','$furnitureFacility','$acFacility','$foodsFacility','$garbageFacility','$rules','$phoneNumber','$paymentMethod','$transactionId','$time')";
